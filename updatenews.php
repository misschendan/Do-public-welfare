                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> 修改活动 </h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            ...
                            <form action="#" class="form-horizontal" id="addnewsform">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="title" name="title" class="span6 " value="<?=$_GET['title'];?>" />
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="neednum" name="neednum" class="span6 " value="<?=$_GET['neednum'];?>"  />
                                        <span class="help-inline"></span>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="times" name="times" class="span6 " value="<?=$_GET['times'];?>"  />
                                        <span class="help-inline"></span>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="address" name="address" class="span6 "  value="<?=$_GET['address'];?>" />
                                        <span class="help-inline"></span>
                                    </div>
                                </div>

                                <textarea id="uploadEditor" style="display: none;">
                                </textarea>
                                ...
                                <input type="hidden" id="img" name="img" value="<?=$_GET['img'];?>">
                                ...
                                <div class="form-actions">
                                    <button type="button" class="btn btn-success" id="addnews">修改</button>
