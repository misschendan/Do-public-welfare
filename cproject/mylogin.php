    ...
    <div class="login-wrap">
        ...
        <div class="metro double-size green">
            <div class="input-append lock-input">
                <input type="text" name="regname" id="regname" class="" placeholder="账号" value="<?=$_COOKIE['regname'];?>">
                <span></span>
            </div>
        </div>
        ...
        <div class="login-footer">
            <div class="remember-hint pull-left">
                <input type="checkbox" <?=$_COOKIE['regname'] && $_COOKIE['passwd'] ? 'checked':'';?> name="remember" id="remember" value="1"> 记住我
            </div>
        </div>
    </div>
