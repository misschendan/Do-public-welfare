...
document.getElementById('upload_img_btnss').onclick = function() {
...
function _beforeInsertImage(t, result) {
    ...
    document.getElementById('upload_img_wrapss').innerHTML = imageHtml;
    document.getElementById('upload_img_btnss').innerHTML = '已上传';
    //如果需要保存图片地址到数据，还需要把所有的图片地址作为输入值
    //具体怎么设置看项目需求，我这里只是举个例子
    //'imgval':要和31行的id对应
    document.getElementById('imgvalss').value = imgval;
}
