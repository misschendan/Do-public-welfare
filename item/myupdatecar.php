<?php 
    ...
    //获取原始信息
    $cate = $db->getOneData('car', '*', 'car_id=' . $_GET['car_id']);
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> 修改图片 </h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            ...
                            <form action="#" class="form-horizontal" id="addcateform">
                                <input type="hidden" name="car_id" id="car_id" value="<?=$cate['car_id'];?>">
                                <!-- 
...
<!-- 加载编辑器的容器：用来上传图片的，必须要，不然上传的图片会追加到上面的编辑器里面或者直接报错 -->
        ...
        <input type="hidden" id="imgvalss" name="imgvalss" class="imgvalss" value="">
                                    ...
                                    <button type="button" class="btn btn-success" id="addcar">修改</button>
