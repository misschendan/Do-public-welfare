                        ...
                        <div class="widget-body">
                            ...
                            <form action="#" class="form-horizontal" id="addthemepicform">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="pic_name" name="pic_name" class="span6 " />
                                ...
                                <input type="hidden" id="pic_address" name="pic_address" value="">
                                <span></span>

                                <div class="form-actions">
                                    <button type="button" class="btn btn-success" id="addthemepic">添加</button>
