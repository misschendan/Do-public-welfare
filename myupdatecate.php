...
require  './common/common.php';
   ...
   if ($_GET['article_id']) {
    //echo $_GET['article_id'];
     $article = $db->getOneData('article', '*', 'article_id=' . $_GET['article_id']);
    }else{
      $article = $db->getOneData('article', '*', 'article_id');
    }
     ...
     <input type="hidden" id="article_id" name="article_id" value="<?=$_GET['article_id'];?>">
            ...
            <div class="hidde" id="jiyu">
                                ...
                                <div class="form-actions">
                                    <button type="button" class="btnsuccess" id="addcontent">修改</button>
                                </div>
