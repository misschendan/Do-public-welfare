          ...
          <div id="sidebar" class="nav-collapse collapse">
              ...
              <ul class="sidebar-menu">
                  <li class="sub-menu active">
                      ...
                      <ul class="sub">
                          <li><a class="" href="newslist.php">新闻管理</a></li>
                          <li><a class="" href="addnews.php">新闻添加</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu active">
                      <a href="javascript:;" class="">
                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                            <form action="#" class="form-horizontal" id="addthemepicform">
                                
                                <div class="control-group">
                                    <label class="control-label">图片标题</label>
                                    <div class="controls">
                                        <input type="text" id="pic_name" name="pic_name" class="span6 " value="<?=$_GET['pic_name'];?>" />
                                        <span class="help-inline"></span>
                                    </div>
                                </div>

                                <textarea id="uploadEditor" style="display: none;"></textarea>
                                <p id="j_upload_img_btn" style="cursor: pointer;" class="btn">图片上传按钮</p>
                                <ul id="upload_img_wrap">
                                <li>
                                <img src="<?=$_GET['pic_address'];?>">
                                </li>
                                </ul><input type="hidden" id="pic_address" name="pic_address" value="<?=$_GET['pic_address'];?>">
                                <span></span>
                                
                                <input type="hidden" id="pic_id" name="pic_id" value="<?=$_GET['pic_id'];?>">

                                <div class="form-actions">
                                    <button type="button" class="btn btn-success" id="addthemepic">修改</button>
    ...
    <script type="text/javascript">
        ...
        // 这里需要实例化一个新的编辑器，防止和上面的编辑器的内容冲突
            ...
            function _beforeInsertImage(t, result) {
                ...
                //'img':要和31行的id对应
                document.getElementById('pic_address').value = pic_address;
            }
